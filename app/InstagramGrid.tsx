...
const posts = [
  { src: '/instagram/post1.jpg', alt: 'Recent Stitchery project 1' },
  { src: '/instagram/post2.jpg', alt: 'Recent Stitchery project 2' },
  { src: '/instagram/post3.jpg', alt: 'Recent Stitchery project 3' },
  { src: '/instagram/post4.jpg', alt: 'Recent Stitchery project 4' },
  { src: '/instagram/post5.jpg', alt: 'Recent Stitchery project 5' },
  { src: '/instagram/post6.jpg', alt: 'Recent Stitchery project 6' },
];
    ...
    <section className="brand-section bg-[var(--stitch-cream)] px-5 py-16 text-[var(--stitch-navy)] sm:px-8 sm:py-20 lg:py-32">
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="brand-kicker text-[var(--stitch-blue)]">Follow @the_stitchery1</p>
          ...
          <a
            ...
            href="https://www.instagram.com/the_stitchery1/"
          ...
          {posts.map((post, index) => (
            ...
            >
              ...
              <span className="pointer-events-none absolute inset-0 hidden items-center justify-center bg-[rgba(6,17,38,0.4)] opacity-0 transition duration-200 group-hover:opacity-100 md:flex">
                <svg aria-hidden="true" className="h-9 w-9 text-white" viewBox="0 0 24 24" fill="currentColor">
